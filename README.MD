...
Extract identity (IP / User / Org)
   ↓
Resolve policy (limits, algorithm) 👉 *Future Scope*
   ↓
...
Expose `/metrics` endpoint. 👉 *Future Scope*
...
### Phase 3 – API Layer 👉 *Future Scope*
